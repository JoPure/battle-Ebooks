...
(function ($) {
    ...
    function Booklet(inTarget, inOptions) {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            updateOptions = function (newOptions) {
                ...
                // JO MENU
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                if (options.joMenu && $(options.joMenu).length > 0) {
                    $(options.joMenu).find('a.pageMenu').on('click.booklet', function(e) {
                        e.preventDefault();
                        if (isBusy || isDisabled) return;
                        $(options.joMenu).find('a.pageMenu.active').removeClass('active');
                ...
                if (options.joNext && $(options.joNext).length > 0) {
                    customN = $(options.joNext);
                    customN.on('click.booklet', function (e) {
                        e.preventDefault();
                        next();
                    });
                }
                if (options.joPrev && $(options.joPrev).length > 0) {
                    customP = $(options.joPrev);
                    customP.on('click.booklet', function (e) {
                        e.preventDefault();
                        prev();
                    });
                            ...
                            stop: function () {
                                ...
                                if (fullPercent > options.hoverThreshold) {
                                    ...
                                    sF.animate({
                                        left: 'auto',
                                        opacity: 0
                                    }, anim.hover.speed, options.easing).css(css.sF);
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            goToPage = function (newIndex) {
                var speed;
                $(options.joMenu).find('a.pageMenu.active').removeClass('active');
                $('#selector-page-'+ newIndex).addClass('active');
    ...
    $.fn.booklet.defaults = {
        ...
        width: 990,                             // container width
        height: 715,                             // container height
